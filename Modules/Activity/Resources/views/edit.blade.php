    ...
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <form method="post" action="{{ route('activity.update',$activity->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Edit Activity</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input name="title" class="form-control" value="{{ $activity->title }}" required>
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="short_description">Activity Short Description</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="description">Activity Full Description</label>
                                ...
                                <div class="row">
                                    <div class="col-6 colxs-12">
                                        ...
                                        <div class="form-check checkbox">
                                            ...
                                            <img id="imageframe" src="{{ Storage::url($activity->image) }}" width="100px"
                                                height="100px" />
                                        </div>
                                    </div>
                                    {{-- <div class="col-6 colxs-12">
                                        <label>Activity Banner Image</label>
                                        <div class="form-check checkbox">
                                            <input type="file" name="banner_image" class="form-control" onchange="banner_imagepreview()">
                                            <img id="banner_imageframe" src="{{ Storage::url($activity->banner_image) }}" width="100px"
                                                height="100px" />
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-3 colxs-12">
                                        <div class="form-check checkbox">
                                            <input class="form-check-input" id="publish" name="publish" type="checkbox"
                                                value="true" {{ $activity->publish==1?'checked':'' }}>
