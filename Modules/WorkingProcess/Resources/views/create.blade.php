...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            @endif
            <form method="post" action="{{ route('workingprocess.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Add Working Process</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="title">Working Process Title </label>
                                    <input name="title" class="form-control" value="{{ old('title') }}" placeholder="Enter Working Process Title" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
