...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item"><a href="{{ route('department.index') }}">Associated With</a></li>
    ...
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <form method="post" action="{{ route('department.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Add Associated With</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
